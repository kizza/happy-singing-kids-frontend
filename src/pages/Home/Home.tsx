...
const Home = () => {
  ...
  return <div className={styles.Home}>
    ...
    {showing && <div className="flex flex-col space-y-8">
      <section>
        <div className={classnames("flex flex-col  lg:flex-row lg:space-x-6", styles.Inner)}>
          <div className={classnames(styles.Left, "space-y-8 md:space-y-12")}>
            <div className={styles.Edinburgh}>
              <Title styles={["text-aqua"]}>
                Edinburgh Festival Fringe
              </Title>
              <img src={fringe} alt="Performing at the Edinburgh Festival Fringe 2024" />
              <p>
          ...
          <div className={classnames(styles.Right, "mt-4 md:mt-0 mb-4")}>
            <div className={styles.Book}>
              ...
              <img src={bookCover} className="shadow-lg rotate-[3deg] mb-4" alt="Uh Oh Spaghetti-oh out now!" />
