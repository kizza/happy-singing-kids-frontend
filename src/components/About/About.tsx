  ...
  <div className={styles.About}>
    <div className={styles.Inner}>
      <div className={styles.Text}>
        <p>Renowned composer and vocalist Susanna O'Leary is a creative powerhouse, delighting fans young and old with her incredible talent and infectious enthusiasm. Her latest project, "Happy Singing Kids," is a delightful sonic adventure that captures Susanna's playful spirit, showcasing fun-loving and sometimes downright silly tunes that have listeners tapping their toes and singing along.</p>
